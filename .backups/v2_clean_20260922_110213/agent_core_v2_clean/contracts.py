UNDERSTANDING_SCHEMA = {
    "type": "object",
    "properties": {
        "user_act": {"type": "string", "enum": ["new_request","follow_up","answer_to_question","request_elaboration","reported_failure","attempt_result","topic_change","social","cancel","escalation","independent_question"]},
        ...
        "clarification_target": {"type": ["string","null"]},
