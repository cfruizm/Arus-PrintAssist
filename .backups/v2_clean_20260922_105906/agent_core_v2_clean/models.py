...
class SupportCase:
    ...
    attempts: list[dict[str, str | None]] = field(default_factory=list)
...
class ConversationMemory:
    ...
    pending_goal: PendingGoal = field(default_factory=PendingGoal)
    support_case: SupportCase = field(default_factory=SupportCase)
    last_assistant_question: str | None = None
    summary: str = ""
    turn_number: int = 0
    topic_history: list[dict[str, Any]] = field(default_factory=list)
    fact_records: dict[str, dict[str, Any]] = field(default_factory=dict)
...
class TurnUnderstanding:
    ...
    current_goal: str
    goal_complete: bool
    goal_updates: dict[str, str] = field(default_factory=dict)
    case_updates: list[dict[str, str]] = field(default_factory=list)
