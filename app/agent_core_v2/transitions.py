...
class TransitionEngine:
 def apply(self,s,d):
  ...
  for f in d.facts:
   ...
   if t=="symptom" and v and not any(norm(x)==norm(v) for x in s.technical_case.symptoms):s.technical_case.symptoms.append(v);s.technical_case.status="diagnosing";a["applied"].append(t)
   ...
   elif t=="affected_scope":s.technical_case.affected_scope=v;a["applied"].append(t)
