...
class SemanticEvidencePipeline:
 ...
 def evaluate(self,query,decision,state,limit=None):
  ...
  model_ids=set(amap)
  # Missing assessments remain unassessed; similarity is not documentary approval.
