...
def enrich_internal_payload(payload,answer_context,understanding):
 ...
 if follow and answer_context:
  ...
  out["continuity_instruction"]="Answer the current follow-up about the previous answer. Validate or qualify prior guidance. Treat confirmed facts as confirmed. Do not promote an unconfirmed scenario to fact. Ask at most one indispensable missing fact."
 return out
