...
SCENARIOS=[
 ...
 {"id":"goal_refinement","name":"Mismo tema refina objetivo","initial":{"active_topic":"Preparar componente","goal":"Validar requisitos previos","intent":"procedural"},"turns":[{"message":"solicitud de operación posterior","understanding":{"user_act":"new_request","intent":"procedural","topic_relation":"same_topic","domain_relevance":"in_scope","current_goal":"Ejecutar la operación solicitada","goal_complete":False,"goal_updates":{},"case_updates":[],"needs_clarification":False,"clarification_target":None,"should_retrieve":True,"confidence":1.0,"reasoning_summary":"fixture","degraded":False}}],"expect":{"goal_exact":"Ejecutar la operación solicitada","action":"defer_to_retrieval"}},
 {"id":"referential_elaboration","name":"Elaboración conserva caso","initial":{"active_topic":"Restaurar servicio","goal":"Diagnosticar interrupción","intent":"troubleshooting"},"turns":[{"message":"solicitud referencial","understanding":{"user_act":"request_elaboration","intent":"troubleshooting","topic_relation":"same_topic","domain_relevance":"in_scope","current_goal":"Explicar la verificación anterior","goal_complete":False,"goal_updates":{},"case_updates":[],"needs_clarification":False,"clarification_target":None,"should_retrieve":True,"confidence":1.0,"reasoning_summary":"fixture","degraded":False}}],"expect":{"goal_exact":"Explicar la verificación anterior","action":"diagnose"}}
]
def _memory(initial):
