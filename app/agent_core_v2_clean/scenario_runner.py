...
SCENARIOS=[
 ...
 {"id":"grounded_diagnostic","name":"Elaboración diagnóstica autoriza recuperación","initial":{"active_topic":"Diagnosticar servicio","goal":"Diagnosticar servicio","intent":"troubleshooting"},"turns":[{"message":"solicitud referencial","understanding":{"user_act":"request_elaboration","intent":"troubleshooting","topic_relation":"same_topic","domain_relevance":"in_scope","current_goal":"Verificar componente compartido","goal_complete":False,"goal_updates":{"symptom":"interrupción general","affected_scope":"todos"},"case_updates":[],"needs_clarification":False,"clarification_target":None,"should_retrieve":True,"confidence":1.0,"reasoning_summary":"fixture","degraded":False}}],"expect":{"action":"diagnose_with_retrieval","case_status":"diagnosing","symptom":"interrupción general","affected_scope":"todos"}},
 {"id":"requirements_route","name":"Requisitos recuperan documentación","initial":{},"turns":[{"message":"consulta de condiciones","understanding":{"user_act":"new_request","intent":"requirements","topic_relation":"new_topic","domain_relevance":"in_scope","current_goal":"Conocer condiciones previas","goal_complete":False,"goal_updates":{},"case_updates":[],"needs_clarification":False,"clarification_target":None,"should_retrieve":True,"confidence":1.0,"reasoning_summary":"fixture","degraded":False}}],"expect":{"action":"defer_to_retrieval"}}
]
def _memory(initial):
...
def run_scenario(scenario):
 ...
 if "affected_scope" in e:add("affected_scope",m.support_case.affected_scope==e["affected_scope"],m.support_case.affected_scope,e["affected_scope"])
