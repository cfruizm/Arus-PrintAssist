...
PROMPT_VERSION="procedural_documented_v10_case_aware_methods"
...
class ProceduralAnswerComposer:
 ...
 def compose(self,message,understanding,retrieval):
  ...
  payload={"question":message,"goal":understanding.get("current_goal"),"document":exp.get("seed_document"),"pages":exp.get("pages"),"evidence":evidence,"confirmed_case_context":retrieval.get("_confirmed_case_context") or {},"confirmed_case_constraints":retrieval.get("_confirmed_case_constraints") or "","procedure_plan":retrieval.get("procedure_plan") or {}}
