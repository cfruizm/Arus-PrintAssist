...
class ControlledInternalKnowledgeComposer:
    ...
    def _call(self, payload, compact=False):
        ...
        budget = 220 if compact else self.max_tokens
        return self.gateway.complete(LLMRequest(
            ...
            "agent_core_v2_clean_internal_knowledge", budget, 0.0, None,
            model_role="answer", response_format_mode="text", reasoning_effort="low"))
