...
class ConversationUnderstanding:
 ...
 def _parse(self,text):
  ...
  raw.setdefault("canonical_subject",None);raw.setdefault("subject_origin",None);raw.setdefault("reference_relation","none");raw.setdefault("goal_complete",False);raw.setdefault("goal_updates",{});raw.setdefault("case_updates",[]);raw.setdefault("needs_clarification",False);raw.setdefault("clarification_target",None);raw.setdefault("should_retrieve",True);raw.setdefault("confidence",0.75);raw.setdefault("reasoning_summary","provider_payload_normalized")
