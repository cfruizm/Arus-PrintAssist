...
@dataclass
class PendingGoal:
 summary:str="";intent:str="unknown";known_details:dict[str,str]=field(default_factory=dict);missing_detail:str|None=None;status:str="inactive";followup_available:bool=False
