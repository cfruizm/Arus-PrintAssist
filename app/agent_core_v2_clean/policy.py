...
class ConversationPolicy:
 def decide(self,u,m):
  ...
  if u.user_act=="request_elaboration" and m.support_case.status=="diagnosing":return AgentDecision("diagnose_with_retrieval","active_case_operational_guidance_requires_grounding")
