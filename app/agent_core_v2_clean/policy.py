...
class ConversationPolicy:
 def decide(self,u,m):
  ...
  if u.degraded and u.should_retrieve:return AgentDecision("defer_to_retrieval","degraded_current_message_recovery")
  if u.degraded:return AgentDecision("degraded_continue","provider_degraded")
  if m.support_case.status=="diagnosing" and u.should_retrieve and u.user_act in {"request_elaboration","answer_to_question","attempt_result"}:return AgentDecision("diagnose_with_retrieval","active_case_next_guidance_requires_grounding")
