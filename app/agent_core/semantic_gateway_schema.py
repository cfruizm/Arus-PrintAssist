...
SEMANTIC_DECISION_SCHEMA={
 ...
 "properties":{
  ...
  "case_updates":{"type":"array","maxItems":5,"items":{"type":"object","additionalProperties":False,"properties":{"type":{"type":"string","enum":["product","process","symptom","attempted_action","attempt_result","affected_scope","error_message","evidence","technical_context","resolution_status"]},"value":{"type":"string","maxLength":400},"confidence":{"type":"number","minimum":0,"maximum":1}},"required":["type","value","confidence"]}},
  "missing_information":{"type":"array","maxItems":3,"items":{"type":"string","maxLength":120}},
  "clarification_question":{"type":["string","null"],"maxLength":300},
  "retrieval_request":{"anyOf":[{"type":"null"},{"type":"object","additionalProperties":False,"properties":{"intent":{"type":"string"},"products":{"type":"array","maxItems":3,"items":{"type":"string"}},"processes":{"type":"array","maxItems":3,"items":{"type":"string"}},"problem_statement":{"type":["string","null"],"maxLength":500},"question":{"type":["string","null"],"maxLength":500},"exclude_actions":{"type":"array","maxItems":5,"items":{"type":"string"}}},"required":["intent","products","processes","problem_statement","question","exclude_actions"]}]},
